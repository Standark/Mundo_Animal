                                    ...
                                    <div id="producto">
                                        <table id ="producto-flitros" >
                                            ...
                                            <ul>
                                                ...
                                                <li>Nombre producto: <b><%=listProd.get(i).getNombre()%></b> ----- Descripción: <b><%=listProd.get(i).getDescripcion()%></b> ----- Cantidad: <b><%=listProd.get(i).getPrecio()%></b><b><button class ="btn" type="submit" >Añadir al carrito</button></b></li>
                                                    <%}%>
                                            </ul>
                                            <%} else {%>
