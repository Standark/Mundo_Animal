                            ...
                            <tr>
                                <td valign="top" >
                                    ...
                                    <section>
                                        ...
                                        <form action="Registro" class="contact-form" onsubmit="return validar(this);">				
                                            <div class="formulario">
                                                <div class="column">
                                                    ...
                                                    <input type="text" name="nacimiento" class="form-input"  placeholder="01-01-2001" onblur="revisar(this);"/>
